// Source: https://www.algoexpert.io/frontend/coding-questions/flatten
...
function flatten(value) {
  // Primitives or null => return as-is
...
function flattenObject(object) {
  ...
  for (const [key, value] of Object.entries(object)) {
    if (Array.isArray(value)) {
      flattenedObj[key] = flattenArray(value);
    } else if (typeof value === 'object' && value !== null) {
      Object.assign(flattenedObj, flattenObject(value));
    } else {
