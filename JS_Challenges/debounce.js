// Source: https://www.algoexpert.io/frontend/coding-questions/debounce
...
function debounce(callback, delay, immediate = false) {
  ...
  return function debounced(...value) {
    // Execute callback function only if the timerId is null and immediate is true
    ...
    timerId = setTimeout(() => {
      if (!immediate) callback.apply(this, value);
      timerId = null;
    }, delay);
  };
}
